export const HeartIcon = ({ primary = "#A1E367", secondary = "#2394E0" }) => {
	return (
		<svg
			version="1.1"
			id="Layer_1"
			...
			style={{ background: "rgba(0 0 122.88 122.88)" }}
			xmlSpace="preserve"
		>
			<style type="text/css">
				{`
          .st0{fill-rule:evenodd;clip-rule:evenodd;fill:${primary};}
          .st1{fill-rule:evenodd;clip-rule:evenodd;fill:${secondary};}
        `}
			</style>
			<g>
				<path
